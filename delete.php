...
// Delete record from 'aj' table
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "DELETE FROM aj WHERE id = $id";
...
// Delete record from 'aj1' table
if (isset($_GET['id1'])) {
    $id1 = $_GET['id1'];
    $sql1 = "DELETE FROM aj1 WHERE id = $id1";
...
// Delete record from 'aj2' table
if (isset($_GET['id2'])) {
    $id2 = $_GET['id2'];
    $sql2 = "DELETE FROM aj2 WHERE id = $id2";
...
<body>
            ...
            <table>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result1)) {
                        ...
                        echo "<td>" . $row['amt'] . "</td>";
                        echo "<td><a href='delete.php?id1=" . $row['id'] . "'>Delete</a></td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
    ...
    <div class="container">
        <h3>Datail for Money Lende:r</h3>
        <div class="table-responsive">
            <table>
                <thead>
                    <tr>
